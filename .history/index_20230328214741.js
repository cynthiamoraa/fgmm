  ...
  if (text === "") {
    ...
    function sendSms() {
      ...
      const options = {
        ...
        "Type 1: This is the partial or total removal of the clitoral /n glands (the external and visible part of the clitoris, which is a sensitive part of the female genitals), and/or the prepuce/clitoral hood (the fold of skin surrounding the clitoral glans).
