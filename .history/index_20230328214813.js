...
app.post("/", (req, res) => {
  ...
  if (text === "") {
    ...
    function sendSms() {
      ...
      const options = {
        to: phoneNumber,
        message: "Female genital mutilation is classified into 4 major types:   Type 1: This is the partial or total removal of the clitoral glands (the external and visible part of the clitoris, which is a sensitive part of the female genitals), and/or the prepuce/clitoral hood (the fold of skin surrounding the clitoral glans).
