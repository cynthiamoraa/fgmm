  ...
  if (text === "") {
    ...
    // This is a second level response where the user selected 1 in the first instance
      const resp = "Please listen to our awesome record";
        const mp3Url = "https://www.loc.gov/collections/national-jukebox/about-this-collection/playlists/national-jukebox-sampler/?&embed=resources";
        const playUrl = `<Play url="${mp3Url}" />`;
        // Indicate that the response should end the USSD session
        const call = voice.say(resp,play=playUrl);
        console.log("yyy")
