...
const sms = AfricasTalking.SMS;
 ...
 try {
   // Read the current count value from the count.txt file
   counter = parseInt(fs.readFileSync("count.txt", "utf-8"));
 } catch (err) {
   // If the count.txt file doesn't exist or can't be read, assume the count is 0
...
app.post("/", (req, res) => {
  ...
  counter++  
  fs.writeFileSync("count.txt", ussdCount.toString());
