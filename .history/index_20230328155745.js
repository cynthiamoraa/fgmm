...
app.post("/", (req, res) => {
  ...
  if (text === "") {
    ...
    const from = "YOUR_AFRICAS_TALKING_PHONE_NUMBER";
    const to = "PHONE_NUMBER_TO_CALL";
    const duration = 30; // Call duration in seconds
    ...
    voice.call(
      ...
      (err) => {
        ...
        return;
        // Your code to handle call status here
      }
    );
